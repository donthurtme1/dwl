...
static const unsigned int msep			   = 10;	/* seperation between window borders with edge of monitor */
static const unsigned int wsep			   = 5;		/* seperation between window borders with eachother and edge of monitor */
static const float rootcolor[]             = COLOR(0x00000000);
static const float bordercolor[]           = COLOR(0x56526e77); /* hypr: 0x595959aa pine: 0x31748f50 */
static const float focuscolor[]            = COLOR(0x31748f77); /* rose: 0xebbcbaaa foam: 0x9ccfd8aa */
static const float urgentcolor[]           = COLOR(0xeb6f92dd); /* love: 0xeb6f92dd */
/* To conform the xdg-protocol, set the alpha to zero to restore the old behavior */
static const float fullscreen_bg[]         = {0.1f, 0.1f, 0.1f, 1.0f}; /* You can also use glsl colors */
static char * const swaybg_argv[]		   = { "swaybg", "-i", "/home/basil/images/nicesky.jpg", "-m", "fill", "-o", "DP-1", NULL };
...
static const float calibration_matrix[6] = { 1, 0, 0, 0, 1, 0 };
...
//static const char *grimcmd[] = { "/usr/bin/grim", "/home/basil/screenshots/screen_shot*.jpg", NULL };
static const char *grimcmd[] = { "/home/basil/grimctl/old/grimctl", NULL };
...
static const Key keys[] = {
	...
	TAGKEYS(          XKB_KEY_6, XKB_KEY_asciicircum,                 4),
	TAGKEYS(          XKB_KEY_7, XKB_KEY_ampersand,                   5),
	TAGKEYS(          XKB_KEY_8, XKB_KEY_asterisk,                    6),
	TAGKEYS(          XKB_KEY_9, XKB_KEY_parenleft,                   7),
	TAGKEYS(          XKB_KEY_0, XKB_KEY_parenright,                  8),
